...
R package **lpjmlstats**, version **0.4.3**
...
Hötten D, Breier J (2024). _lpjmlstats: Statistical tools for LPJmL data analysis_. R package version 0.4.3, <https://github.com/PIK-LPJmL/lpjmlstats>.
