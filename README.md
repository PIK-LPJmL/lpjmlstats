...
R package **lpjmlstats**, version **0.10.2**
...
Hötten D, Breier J, Müller C, Wirth S (2026). "lpjmlstats: Statistical tools for LPJmL data analysis." Version: 0.10.2, <https://github.com/PIK-LPJmL/lpjmlstats>.
