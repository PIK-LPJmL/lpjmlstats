...
R package **lpjmlstats**, version **0.3.0**
...
Hötten D, Breier J (2024). _lpjmlstats: Statistical tools for LPJmL data analysis_. R package version 0.3.0, <https://github.com/PIK-LPJmL/lpjmlstats>.
