...
# retrieve meta data from the benchmark object
baseline_dir <- attr(bench_data, "baseline_dir")
under_test_dirs <- attr(bench_data, "ut_dir")
description <- attr(bench_data, "description")
